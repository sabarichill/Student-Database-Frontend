      ...
      <div className="form-card">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-grid">
            ...
            <div className="field">
              <label>Phone (max 10 digits)</label>
              <input name="phone" type="number" value={form.phone} onChange={handleChange} placeholder="10 digit number" />
              {errors.phone && <span className="error">{errors.phone}</span>}
            </div>

            <div className="field">
              <label>CGPA (0-10)</label>
              <input name="cgpa" type="number" step="0.1" value={form.cgpa} onChange={handleChange} placeholder="e.g. 8.5" />
              {errors.cgpa && <span className="error">{errors.cgpa}</span>}
            </div>

            <div className="field">
              <label>YOP (Year of Passing)</label>
              <input name="yop" type="number" value={form.yop} onChange={handleChange} placeholder="e.g. 2025" min="1000" max="9999" />
              {errors.yop && <span className="error">{errors.yop}</span>}
            </div>

            <div className="field full-width">
              <label>Address</label>
              <input name="address" value={form.address} onChange={handleChange} placeholder="City / Address" />
            </div>
